...
function Pricing() {
    ...
    const handleUpgradeClick = (e) => {
        ...
        // If logged in, do nothing or redirect to upgrade page (if existed)
    };
    ...
    const handleScrollToAllFeatures = (e) => {
        ...
        if (element) {
            // Using lenis if global or standard scroll
                ...
                <FadeIn direction="up" amount={0.4}>
                    ...
                    <div className="pricing-container">
                        ...
                        <div className="pricing-card-wrapper">
                            ...
                            {/* Explore All Features Button (Outside Pro Card) */}
                            <a href="#all-features" className="explore-link" onClick={handleScrollToAllFeatures}>
